...
public enum ErrorCode {
    ...
    FILE_CANNOT_DELETED(1003, "File cannot be deleted.", HttpStatus.INTERNAL_SERVER_ERROR),
    FILE_IS_EMPTY(1004, "Uploaded file is empty.", HttpStatus.BAD_REQUEST),
    INVALID_FILE_PATH(1005, "Filename contains invalid path sequence.", HttpStatus.BAD_REQUEST),
    FILE_STORAGE_INIT_ERROR(1006, "Could not initialize file storage.", HttpStatus.INTERNAL_SERVER_ERROR),
    // Lỗi vai trò (14xx)
